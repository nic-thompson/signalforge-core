...
Two protocols, defined in `stream_pipeline.detection.protocols`:
...
- `stream_pipeline/detection/` — the detection package; `protocols.py` for the two protocols, `detectors/` for the three implementations, `types.py` for detection-type constants.
