...
The callers. Nothing polls the ingestion queue; nothing reads the archive. `stream_pipeline.replay`'s production event source still raises `NotImplementedError`. See `docs/phases/phase-8-plan.md`.
