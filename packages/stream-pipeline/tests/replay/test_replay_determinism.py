...
from stream_pipeline.dashboards.dynamodb_projection_store import DynamoDbProjectionStore
...
from stream_pipeline.streaming.realtime_pipeline import ProcessingResult, RealtimePipeline
