"""
stream_pipeline.datasets.s3_writer
...
from stream_pipeline.datasets.serialisation import SerialisedTable, serialise_partition
from stream_pipeline.datasets.writer import FlushedPartition, _PartitionBufferSet
