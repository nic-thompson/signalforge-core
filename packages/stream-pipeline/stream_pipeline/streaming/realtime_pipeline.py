"""
stream_pipeline.streaming.realtime_pipeline
...
from stream_pipeline.features import FEATURE_SCHEMA_VERSION
...
if TYPE_CHECKING:
    ...
    # stream_pipeline.datasets.writer imports ProcessingResult from this
    ...
    from stream_pipeline.datasets.writer import DatasetWriter
...
_FEATURE_EVENT_SOURCE: Final[str] = "stream-pipeline.realtime_pipeline"
...
class ProcessingResult:
    ...
    in ``stream_pipeline.detection.protocols``.
