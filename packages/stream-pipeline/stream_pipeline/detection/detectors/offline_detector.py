"""
stream_pipeline.detection.detectors.offline_detector
...
from stream_pipeline.detection.types import DETECTION_TYPE_DEVICE_OFFLINE, DETECTION_TYPE_DEVICE_ONLINE
...
class OfflineDetector:
    ...
    _SOURCE = "stream-pipeline.offline_detector"
