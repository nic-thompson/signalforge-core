"""
Tests for signal_forge.dashboards.dynamodb_projection_store.
...
from signal_forge.dashboards.dynamodb_projection_store import (
    _DEFAULT_ANOMALY_RATE_TTL_SECONDS,
    DynamoDbProjectionStore,
)
from signal_forge.dashboards.offline_count_projection import OfflineCountProjection
